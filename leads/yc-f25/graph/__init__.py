"""
Graph definition for yc-f25 leads table.
...
Usage:
  ...
  workflow = load_workflow("full_enrichment")

  # Load a single instance
  node = load_instance("yc_founder")
"""
...
from .nodes import NODES, YCFounderLookup, LinkedInPostsScraper, ClaudeCodeDetector
