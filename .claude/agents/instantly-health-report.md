...
```bash
source .venv/bin/activate && python .claude/skills/instantly-analytics/scripts/build_report_html.py
```
...
- `.claude/skills/instantly-analytics/docs/email-infrastructure.md`
